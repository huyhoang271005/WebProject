...
export function convertToVNTime(utcString) {
    ...
    // MẸO: Nếu chuỗi chưa có Z (giờ UTC chuẩn) và chưa có múi giờ (+07), hãy gắn thêm Z vào.
    const standardUtcString = utcString.endsWith('Z') || utcString.includes('+')
        ? utcString
        : utcString + 'Z';

    const date = new Date(standardUtcString);
    ...
    return date.toLocaleString("vi-VN", {
        ...
        hour12: false, // Dùng định dạng 24h cho chuyên nghiệp
        year: 'numeric',
        month: '2-digit',
        day: '2-digit',
        hour: '2-digit',
